				...
				{!! Form::model($machine_type , ['method' => 'POST', 'url' => 'machine_type/'.$machine_type->id /*, 'class' => 'form-inline'*/]) !!}
					...
					<div class="panel-body">
						...
						<p>Machine Description: </p>
							{!! Form::input('string', 'machine_desc', $machine_type->machine_desc, ['class' => 'form-control']) !!}
						</div>

						<div class="panel-body">
						<p>Machine Group: </p>
							{!! Form::input('string', 'machine_group', $machine_type->machine_group, ['class' => 'form-control']) !!}
						</div>
