	...
	<div class="row vertical-center-row">
			...
			<div class="text-center col-md-6 col-md-offset-3">
				<div class="panel panel-default">
					<div class="panel-heading">Link machine to SETTING activity &nbsp &nbsp &nbsp &nbsp 
					...
					<div class="panel-body">
							...
							<p>Scan / type Machine OS</p>
								{!! Form::text('machine', null, ['class' => 'form-control', 'autofocus' => 'autofocus', 'disabled' => 'disabled']) !!}
							</div>
								<span style='color:red'>For activity with PENDING status you can not add new machines.</span>
							@endif
